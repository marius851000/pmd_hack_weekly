...
- [Pokémon Mystery Dungeon: Exploradores dos Céus was added to the list of mods (translation in Brazilian Portuguese)](https://hacks.skytemple.org/h/exploradores)
  - [ded6giu and Wangaloide being a bit slow, they published a WIP patch](https://cdn.discordapp.com/attachments/769498453126283274/817802479160524860/patch_03-06-2021.xdelta). It include some of the early game text, including the full chapter 1, as well as some chapter 2 and 3.
...
![list of move effect by move](./images/21-02-2/moveeffect.png)
